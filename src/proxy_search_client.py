...
class ProxySearchClient:
    ...
    def run_search(self, query: str, system_prompt: Optional[str] = None) -> str:
        ...
        for model_name, payload, label in attempts:
            ...
            if raw_content.strip():
                has_grounding = self._has_grounding_markers(raw_content)
                cleaned = self._strip_proxy_grounding(raw_content)
