...
- **Intuitive GUI:** Add a "Convert" toggle and an editable language field.
...
- **UI:** 
    - Add "Convert" toggle (`AnimatedToggle`) to `MainWindow`.
    - Add "Target Language" input field (`QLineEdit`) to `MainWindow`.
- **Controller/Worker:**
